  ...
  <body>
    <div class="container">
      <div class="header clearfix text-center">        
        <img class="media-object" src="{!! asset('localhost/public/img/mouthpiece.png') !!}" alt="MouthPiece">
      </div>     

      <div class="row marketing text-center">
        <p>Dear {!! $recipentusername !!},</p>
        <p><strong>{!! $recipentusername !!}</strong> sent you a new message</p>
        <p>{!! $bodymessage !!}</p>                    
        <p class="bodymesage"><a href="#" class="btn btn-primary btn-large" style="background-color: #B5CB05;">Reply</a></p>        
      </div>
