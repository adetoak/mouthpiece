  ...
  <body>
    <div class="container">
      ...
      <div class="row marketing">
        <p>Dear {!! $username !!},</p>   
        <p>Welcome to Mouthpiece Nigera. Your account has been created.</p> 
        <p>Click on the button below to activate your account or copy this url directly to your browser to activate your account</p>
        <p><a href="{{ route('confirmation', $token) }}" class="btn btn-primary btn-large" style="background-color: #B5CB05;">Activate my account</a></p>
        <h3></h3>
